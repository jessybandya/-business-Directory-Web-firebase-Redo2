...
function Posts({address,postId,businessName,descriptions,industry,location,ownerEmail,timestamp,ownerId,ownerUsername,ownerphotoURL,phone,postImage}) {
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 results-display" itemscope itemtype="#">
                            <div class="row">
                                        ...
                                        <a itemprop="url" href={`list-businesses-details/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}`} title="Avenue Motors Ltd"> 
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 infoarea"> 
                                    <a itemprop="url" href={`list-businesses-details/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}`}>
                    ...
                    <span class="streetaddress" itemprop="address"> <a class="category" style={{color: "#000"}} title="Discover Car Hire in Car Hire" href={`list-businesses-details/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}`}>
                                                                        <i class="fas fa-location-arrow"></i></a> 
                                                                                        ...
                                                                                        <span>Category:</span> 
                                                                                        <a class="thecategory" data-value="1" data-business="Avenue Motors Ltd" data-catname="Car Hire" href={`list-businesses-details/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}`} title="Car Hire">{industry}
                                                                                        </a>
                                                                                    </div>
                                                                    ...
                                                                    <a href={`/businesses-email/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}/${businessName}/${industry}`} title={`send an email message to ${businessName}`} class="bizemail">Message</a> 
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                    </div>
